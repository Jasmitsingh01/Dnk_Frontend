...
function Home() {
  ...
  useLayoutEffect(() => {
    ...
    Data.then((data) => setFreautred(data?.product)).finally(()=>{
      setloading(false);
    ...
    <div>
      ...
      <div className="relative lg:top-[100vh] bg-slate-100 py-20">
        ...
        <div className=" border-2 border-blue-500 w-[100px] mx-auto mb-20"></div>
          ...
          {
          loading? <div className=" flex justify-center text-2xl">  <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
